            ...
            <div class="objects__layout">
                ...
                <ul class="objects__grid">
                    <?php foreach ($objects as $o) : ?>
                        <li class="object-card"><span class="object-card__num"><img src="<?php echo rezka_asset('icons-dark/logo-mark.svg'); ?>" alt="" width="14" height="10" aria-hidden="true"><?php echo esc_html($o['number']); ?></span>
                            <div class="object-card__body">
                                <h3 class="object-card__title"><?php echo esc_html($o['title']); ?></h3>
        ...
        <div class="container contacts__inner">
            ...
            <div class="contacts__cards">
                <div class="contact-card">
                    ...
                    <div><span class="contact-card__label">Адрес офиса</span>
                ...
                <a class="contact-card" href="tel:<?php echo esc_attr($phone_r); ?>">
                    ...
                    <div><span class="contact-card__label">Телефон</span>
                        <p class="contact-card__value"><?php echo esc_html($phone); ?></p>
                    </div>
                </a>
                <a class="contact-card" href="https://wa.me/<?php echo esc_attr($wa); ?>" target="_blank" rel="noopener">
                    ...
                    <div><span class="contact-card__label">WhatsApp</span>
                        <p class="contact-card__value"><?php echo esc_html($wa_l); ?></p>
                    </div>
                </a>
                <a class="contact-card" href="https://t.me/+<?php echo esc_attr(ltrim($tg, '+')); ?>" target="_blank" rel="noopener">
                    ...
                    <div><span class="contact-card__label">Telegram</span>
                        <p class="contact-card__value"><?php echo esc_html($tg_l); ?></p>
                    </div>
                </a>
                <a class="contact-card" href="mailto:<?php echo esc_attr($email); ?>">
                    ...
                    <div><span class="contact-card__label">Email</span>
